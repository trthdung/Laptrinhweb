...
if (isset($_POST['datlich'])) {
    ...
    if (
        ...
        if ($thoigian <= time()) {
            $message =
                "Không thể đặt lịch trong thời gian đã qua.";
        ...
        elseif (
            ...
            $message =
                "Giảng viên đã có lịch vào thời gian này. Vui lòng chọn giờ khác.";
...
<option value="Nguyễn Thị Lan - Tiếng Anh">
    Nguyễn Thị Lan - Tiếng Anh
</option>
<option value="Trần Thị Hương - Tiếng Anh">
    Trần Thị Hương - Tiếng Anh
</option>
<option value="Lê Minh Anh - Tiếng Trung">
    Lê Minh Anh - Tiếng Trung
</option>
<option value="Phạm Thu Hà - Tiếng Nhật">
    Phạm Thu Hà - Tiếng Nhật
</option>
<option value="Nguyễn Hoàng Nam - Tiếng Hàn">
